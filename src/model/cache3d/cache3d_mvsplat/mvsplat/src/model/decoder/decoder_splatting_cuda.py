...
from .cuda_splatting import DepthRenderingMode, render_cuda, render_depth_cuda, render_weight_cuda
...
class DecoderSplattingCUDA(Decoder[DecoderSplattingCUDACfg]):
    ...
    def forward(
        ...
        if render_weight:
            ...
            weight = rearrange(weight, "(b v) c h w -> b v c h w", b=b, v=v)
        ...
        return DecoderOutput(
            ...
            weight if render_weight else None,
        )
